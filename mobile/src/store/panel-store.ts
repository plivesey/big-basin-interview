...
// Selectors for optimized subscriptions. The web store subscribes with inline
// accessors; these mirror the convention the other three stores already use.
export const selectIsProviderPanelOpen = (state: PanelState) => state.isProviderPanelOpen;
export const selectDisplayedProviders = (state: PanelState) => state.displayedProviders;
export const selectActiveWorkflowId = (state: PanelState) => state.activeWorkflowId;
export const selectWorkflowState = (state: PanelState) => state.workflowState;
